...
Volg deze stappen om de businessservice op te starten

### Installeren
De business service vereist een aantal programma's om op te kunnen starten.
...
### Docker
Om de business service lokaal te draaien hebben we een aantal andere services nodig, hiervoor maken we gebruik van docker compose. In het `docker-compose.yml` bestand vind je de configuratie.
